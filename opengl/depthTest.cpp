...
//	Shader shaderSingleColor("shaderSingleColor.vs", "shaderSingleColor.fs");
//
//	float cubeVertices[] = {
...
//		glBindVertexArray(0);
//		
//		glStencilFunc(GL_ALWAYS, 1, 0xFF);//下面所欲的片段都应该更新模板缓冲
//		glStencilMask(0xFF);//启用模板缓冲写入正常的箱子片段
//
//		glBindVertexArray(CubeVAO);
...
//		glDrawArrays(GL_TRIANGLES, 0, 36);
//
//		glStencilFunc(GL_NOTEQUAL, 1, 0xFF);//保证只绘制不为1的部分，也就是边框
//		glStencilMask(0x00);
